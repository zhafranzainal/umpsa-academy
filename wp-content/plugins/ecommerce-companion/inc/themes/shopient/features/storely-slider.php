...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	'hide_show_hdr_btn', 
		array(
			'label'	      => esc_html__( 'Hide/Show', 'storely-pro' ),
			'section'     => 'header_navigation',
			'type'        => 'checkbox'
		) 
	);	
	...
	'hdr_btn_lbl', 
		array(
			'label'	      => esc_html__( 'Button Label', 'storely-pro' ),
			'section'     => 'header_navigation',
			'type'        => 'text'
		) 
	);	
	...
	'hdr_btn_url', 
		array(
			'label'	      => esc_html__( 'Button Link', 'storely-pro' ),
			'section'     => 'header_navigation',
			'type'        => 'text'
		) 
	);	
	...
	$wp_customize->add_setting( 'slider2', 
		...
		class storely_slider__section_premium extends WP_Customize_Control {
			...
			?>
				<a class="customizer_slider_section_premium up-to-pro" href="https://sellerthemes.com/shopient-premium/" target="_blank" style="display: none;"><?php _e('More Slides Available in the Premium Version','ecommerce-companion'); ?></a>
	...
	$wp_customize->add_setting( 'slider_info', 
		...
		class storely_slider_info_section_premium extends WP_Customize_Control {
			public function render_content() { 
			?>
				<a class="customizer_slider_info_section_premium up-to-pro" href="https://sellerthemes.com/shopient-premium/" target="_blank" style="display: none;"><?php _e('More Info Available in the Premium Version','ecommerce-companion'); ?></a>
	...
	'slider_info6_head',
		array(
			'type' => 'hidden',
			'label' => __('Slider Info Bottom','ecommerce-companion'),
			'section' => 'slider_setting',
		)
	);
	...
	// Slider Info
	$wp_customize->add_setting( 'slider_info6', 
			array(
			 'sanitize_callback' => 'storely_repeater_sanitize',
			 'priority' => 16,
			  'default' => storely_get_slider_info_default()
